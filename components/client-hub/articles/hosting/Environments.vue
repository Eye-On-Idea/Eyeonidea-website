...
<template>
  <div>
    ...
    <ClientHubArticleImage src="/images/client-hub/hosting/environments-diagram.png" alt="Production and development environment diagram" caption="Production vs. development environments" />
