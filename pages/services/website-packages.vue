...
useSeo({
  ...
  breadcrumbs: [
    ...
    { name: t("servicesSubpages.websitePackages.breadcrumb.services"), url: "https://eyeonidea.com/services" },
    {
      name: t("servicesSubpages.websitePackages.breadcrumb.current"),
      url: "https://eyeonidea.com/services/website-packages",
    },
  ],
});
...
const breadcrumbs = computed(() => [
  { label: "Home", to: "/" },
  {
    label: t("servicesSubpages.websitePackages.breadcrumb.services"),
    to: "/services",
  },
...
const navSections = computed<SectionNavItem[]>(() => [
  {
    id: "packages-section",
    label: t("servicesSubpages.websitePackages.nav.packages"),
    icon: "i-heroicons-cube",
  },
  {
    id: "comparison-section",
    label: t("servicesSubpages.websitePackages.nav.comparison"),
    icon: "i-heroicons-table-cells",
  },
  {
    id: "cms-section",
    label: t("servicesSubpages.websitePackages.nav.cms"),
    icon: "i-heroicons-square-3-stack-3d",
  },
  {
    id: "hosting-section",
    label: t("servicesSubpages.websitePackages.nav.hosting"),
    icon: "i-heroicons-server",
  },
  {
    id: "before-after-section",
    label: t("servicesSubpages.websitePackages.nav.results"),
    icon: "i-heroicons-chart-bar",
  },
]);

const hostingData = computed(() =>
  t(
    "servicesSubpages.websitePackages.hosting.hostingCard",
    {},
    { missingWarn: false },
  )
    ? {
        ...
        description: t(
          "servicesSubpages.websitePackages.hosting.hostingCard.description",
        ),
        bullets: tm(
          "servicesSubpages.websitePackages.hosting.hostingCard.bullets",
        ) as string[],
        price: t("servicesSubpages.websitePackages.hosting.hostingCard.price"),
        currency: t(
          "servicesSubpages.websitePackages.hosting.hostingCard.currency",
        ),
        unit: t("servicesSubpages.websitePackages.hosting.hostingCard.unit"),
        vatNote: t(
          "servicesSubpages.websitePackages.hosting.hostingCard.vatNote",
        ),
      }
    : null,
);
...
const domainData = computed(() => ({
  ...
  description: t(
    "servicesSubpages.websitePackages.hosting.domainCard.description",
  ),
  includedNote: t(
    "servicesSubpages.websitePackages.hosting.domainCard.includedNote",
  ),
            ...
            <div class="card-inner">
              <div class="card-top">
                <span class="eu-badge">
                  ...
                  {{
                    t(
                      "servicesSubpages.websitePackages.hosting.hostingCard.badge",
                    )
                  }}
                </span>
                <h3 class="card-title">
                  {{
                    t(
                      "servicesSubpages.websitePackages.hosting.hostingCard.title",
                    )
                  }}
                </h3>
              ...
              <div class="card-price">
                ...
                <span class="price-amount">
                  {{
                    ...
                    t(
                      "servicesSubpages.websitePackages.hosting.hostingCard.price",
                    )
                  }}
                </span>
                <span class="price-unit"
                  ...
                  {{
                    t(
                      "servicesSubpages.websitePackages.hosting.hostingCard.unit",
                    )
                  }}</span
                >
            ...
            <div class="card-inner">
              <div class="card-top">
                ...
                <h3 class="card-title">
                  {{
                    t(
                      "servicesSubpages.websitePackages.hosting.domainCard.title",
                    )
                  }}
                </h3>
                <p class="card-description">
              ...
              <NuxtLink
                :to="
                  t(
                    'servicesSubpages.websitePackages.hosting.domainCard.linkHref',
                  )
                "
                class="domain-link"
              >
                {{
                  t(
                    "servicesSubpages.websitePackages.hosting.domainCard.linkText",
                  )
                }}
                <UIcon
                  name="i-heroicons-arrow-right"
                  class="domain-link__icon"
                  aria-hidden="true"
                />
              </NuxtLink>
            </div>
